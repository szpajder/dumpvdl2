...
asn_dec_rval_t
Mechanism_name_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Mechanism_name_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_Mechanism_name = {
	...
	Mechanism_name_decode_uper,
	Mechanism_name_encode_uper,
