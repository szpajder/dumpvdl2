...
static asn_TYPE_member_t asn_MBR_LongitudeDegreesMinutesSeconds_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LongitudeDegreesMinutesSeconds, wholeDegrees),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LongitudeDegreesMinutesSeconds, wholeMinutes),
		(ASN_TAG_CLASS_UNIVERSAL | (2 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LongitudeDegreesMinutesSeconds, seconds),
		(ASN_TAG_CLASS_UNIVERSAL | (2 << 2)),
		0,
