...
typedef struct PeriodicContractRequest {
	...
	ProjectedProfileModulus_t	*projected_profile_modulus	/* OPTIONAL */;
	GroundVectorModulus_t	*ground_vector_modulus	/* OPTIONAL */;
	AirVectorModulus_t	*air_vector_modulus	/* OPTIONAL */;
	...
	SpeedScheduleProfileModulus_t	*speed_schedule_profile_modulus	/* OPTIONAL */;
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
	RNPProfileModulus_t	*rnp_profile_modulus	/* OPTIONAL */;
	PlannedFinalAppSpeedModulus_t	*planned_final_approach_speed_modulus	/* OPTIONAL */;
