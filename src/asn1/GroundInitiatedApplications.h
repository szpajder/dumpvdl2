...
#ifndef	_GroundInitiatedApplications_H_
#define	_GroundInitiatedApplications_H_
...
typedef struct GroundInitiatedApplications {
	A_SEQUENCE_OF(struct AEQualifierVersionAddress) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} GroundInitiatedApplications_t;
...
#endif	/* _GroundInitiatedApplications_H_ */
