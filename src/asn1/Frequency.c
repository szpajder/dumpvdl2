...
static asn_TYPE_member_t asn_MBR_Frequency_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Frequency, choice.hf),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Frequency, choice.vhf),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Frequency, choice.uhf),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Frequency, choice.satchannel),
