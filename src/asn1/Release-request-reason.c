...
asn_dec_rval_t
Release_request_reason_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Release_request_reason_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Release_request_reason_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Release_request_reason = {
	...
	Release_request_reason_decode_uper,
	Release_request_reason_encode_uper,
	...
	sizeof(asn_DEF_Release_request_reason_tags_1)
		/sizeof(asn_DEF_Release_request_reason_tags_1[0]), /* 1 */
	&asn_PER_type_Release_request_reason_constr_1,
