...
static asn_TYPE_member_t asn_MBR_LongitudeReportingPoints_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LongitudeReportingPoints, direction),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LongitudeReportingPoints, degrees),
...
static const asn_TYPE_tag2member_t asn_MAP_LongitudeReportingPoints_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 0 }, /* degrees */
