...
typedef enum LongitudeType_PR {
	...
	LongitudeType_PR_degrees,
	LongitudeType_PR_degreesMinutes,
	LongitudeType_PR_dMS
} LongitudeType_PR;
...
typedef struct LongitudeType {
	...
	union LongitudeType_u {
		LongitudeDegrees_t	 degrees;
		LongitudeDegreesMinutes_t	 degreesMinutes;
		LongitudeDegreesMinutesSeconds_t	 dMS;
	} choice;
