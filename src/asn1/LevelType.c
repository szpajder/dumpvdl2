...
static asn_TYPE_member_t asn_MBR_LevelType_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LevelType, choice.feet),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LevelType, choice.meters),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LevelType, choice.flightLevel),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LevelType, choice.flightLevelMetric),
...
static const asn_TYPE_tag2member_t asn_MAP_LevelType_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* flightLevel */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* flightLevelMetric */
};
