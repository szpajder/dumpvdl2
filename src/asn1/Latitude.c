...
static asn_TYPE_member_t asn_MBR_Latitude_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Latitude, type),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Latitude, direction),
...
static const asn_TYPE_tag2member_t asn_MAP_Latitude_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 0, 0, 0 }, /* degreesMinutes */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 0, 0, 0 } /* dMS */
};
