...
static ASN1_FORMATTER_FUN_T(asn1_format_CHOICE_acse_as_json) {
	format_CHOICE_as_json(p, NULL, asn1_format_acse_as_json);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Associate_result_as_json) {
	format_INTEGER_as_ENUM_as_json(p, Associate_result_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Release_request_reason_as_json) {
	format_INTEGER_as_ENUM_as_json(p, Release_request_reason_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Release_response_reason_as_json) {
	format_INTEGER_as_ENUM_as_json(p, Release_response_reason_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ABRT_source_as_json) {
	format_INTEGER_as_ENUM_as_json(p, ABRT_source_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_CHOICE_icao_as_json) {
	format_CHOICE_as_json(p, NULL, asn1_format_icao_as_json);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SEQUENCE_icao_as_json) {
	format_SEQUENCE_as_json(p, asn1_format_icao_as_json);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SEQUENCE_OF_icao_as_json) {
	format_SEQUENCE_OF_as_json(p, asn1_format_icao_as_json);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ATCDownlinkMsgElementId_as_json) {
	format_CHOICE_as_json(p, ATCDownlinkMsgElementId_labels, asn1_format_icao_as_json);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ATCUplinkMsgElementId_as_json) {
...
static ASN1_FORMATTER_FUN_T(asn1_format_AltimeterEnglish_as_json) {
	format_INTEGER_with_unit_as_json(p, "inHg", 0.01);
}

static ASN1_FORMATTER_FUN_T(asn1_format_AltimeterMetric_as_json) {
	format_INTEGER_with_unit_as_json(p, "hPa", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Deg_as_json) {
	format_INTEGER_with_unit_as_json(p, "deg", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_DepartureMinimumInterval_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_DistanceKm_as_json) {
	format_INTEGER_with_unit_as_json(p, "km", 0.25);
}

static ASN1_FORMATTER_FUN_T(asn1_format_DistanceNm_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Humidity_as_json) {
	format_INTEGER_with_unit_as_json(p, "%%", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_DistanceEnglish_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_DistanceMetric_as_json) {
	format_INTEGER_with_unit_as_json(p, "km", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Frequencyvhf_as_json) {
	format_INTEGER_with_unit_as_json(p, "MHz", 0.005);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Frequencyuhf_as_json) {
	format_INTEGER_with_unit_as_json(p, "MHz", 0.025);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Frequencyhf_as_json) {
	format_INTEGER_with_unit_as_json(p, "kHz", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_LegTime_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_LevelFeet_as_json) {
	format_INTEGER_with_unit_as_json(p, "ft", 10);
}

static ASN1_FORMATTER_FUN_T(asn1_format_LevelFlightLevelMetric_as_json) {
	format_INTEGER_with_unit_as_json(p, "m", 10);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Meters_as_json) {
...
static ASN1_FORMATTER_FUN_T(asn1_format_RTATolerance_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Feet_as_json) {
	format_INTEGER_with_unit_as_json(p, "ft", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SpeedMetric_as_json) {
	format_INTEGER_with_unit_as_json(p, "km/h", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SpeedEnglish_as_json) {
	format_INTEGER_with_unit_as_json(p, "kts", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SpeedIndicated_as_json) {
	format_INTEGER_with_unit_as_json(p, "kts", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_SpeedMach_as_json) {
	format_INTEGER_with_unit_as_json(p, "", 0.001);
}

static ASN1_FORMATTER_FUN_T(asn1_format_Temperature_as_json) {
	format_INTEGER_with_unit_as_json(p, "C", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_VerticalRateEnglish_as_json) {
	format_INTEGER_with_unit_as_json(p, "ft/min", 10);
}

static ASN1_FORMATTER_FUN_T(asn1_format_VerticalRateMetric_as_json) {
	format_INTEGER_with_unit_as_json(p, "m/min", 10);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EstimatedPositionUncertainty_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.01);
}
...
static ASN1_FORMATTER_FUN_T(asn1_format_ADSv2Temperature_as_json) {
	format_INTEGER_with_unit_as_json(p, "C", 0.25);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ADSv2WindSpeedKts_as_json) {
	format_INTEGER_with_unit_as_json(p, "kts", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ADSv2WindSpeedKmh_as_json) {
	format_INTEGER_with_unit_as_json(p, "km/h", 2);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EmergencyUrgencyStatus_as_json) {
	format_BIT_STRING_as_json(p, EmergencyUrgencyStatus_bit_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EPPTimeInterval_as_json) {
	format_INTEGER_with_unit_as_json(p, "minutes", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EventTypeNotSupported_as_json) {
	format_BIT_STRING_as_json(p, EventTypeNotSupported_bit_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_GrossMass_as_json) {
	format_INTEGER_with_unit_as_json(p, "kg", 10);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EPPLimitations_as_json) {
	format_BIT_STRING_as_json(p, EPPLimitations_bit_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EPPTolETA_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EPPTolGCDistance_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.01);
}

static ASN1_FORMATTER_FUN_T(asn1_format_EPUChangeTolerance_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.01);
}

static ASN1_FORMATTER_FUN_T(asn1_format_GroundSpeed_as_json) {
	format_INTEGER_with_unit_as_json(p, "kts", 0.5);
}

static ASN1_FORMATTER_FUN_T(asn1_format_GroundTrack_as_json) {
	format_INTEGER_with_unit_as_json(p, "deg", 0.05);
}

static ASN1_FORMATTER_FUN_T(asn1_format_LateralDeviationThreshold_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_MachNumberTolerance_as_json) {
	format_INTEGER_with_unit_as_json(p, "", 0.01);
}

static ASN1_FORMATTER_FUN_T(asn1_format_ReportTypeNotSupported_as_json) {
	format_BIT_STRING_as_json(p, ReportTypeNotSupported_bit_labels);
}

static ASN1_FORMATTER_FUN_T(asn1_format_RNPValue_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_TurbulenceEDRValue_as_json) {
	format_INTEGER_with_unit_as_json(p, "m^2/s^3", 0.01);
}

static ASN1_FORMATTER_FUN_T(asn1_format_TurbulenceMinutesInThePast_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 0.5);
}

static ASN1_FORMATTER_FUN_T(asn1_format_TurbulenceObservationWindow_as_json) {
	format_INTEGER_with_unit_as_json(p, "min", 1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_TurnRadius_as_json) {
	format_INTEGER_with_unit_as_json(p, "nm", 0.1);
}

static ASN1_FORMATTER_FUN_T(asn1_format_VerticalType_as_json) {
	format_BIT_STRING_as_json(p, VerticalType_bit_labels);
}
...
asn_formatter_t const asn1_icao_formatter_table_json[] = {
	...
	{ .type = &asn_DEF_DMVersionNumber, .format = asn1_format_long_as_json, .label = "version" },
	{ .type = &asn_DEF_ErrorInformation, .format = asn1_format_ENUM_as_json, .label = "error_info" },
	...
	{ .type = &asn_DEF_NavaidName, .format = asn1_format_any_as_string_as_json, .label = "navaid_name" },
	...
	{ .type = &asn_DEF_RouteClearanceIndex, .format = asn1_format_long_as_json, .label = "route_clearance_idx" },
	...
	{ .type = &asn_DEF_AEQualifier, .format = asn1_format_long_as_json, .label = "ae_qualifier" },
	...
	{ .type = &asn_DEF_CMAbortReason, .format = asn1_format_ENUM_as_json, .label = "atn_context_mgmt_abort_reason" },
	...
	{ .type = &asn_DEF_CMContactResponse, .format = asn1_format_ENUM_as_json, .label = "atn_context_mgmt_contact_response" },
	{ .type = &asn_DEF_CMForwardRequest, .format = asn1_format_SEQUENCE_icao_as_json, .label = "atn_context_mgmt_forward_request" },
	{ .type = &asn_DEF_CMForwardResponse, .format = asn1_format_ENUM_as_json, .label = "atn_context_mgmt_forward_response" },
	...
	{ .type = &asn_DEF_VersionNumber, .format = asn1_format_long_as_json, .label = "version" },
	...
	{ .type = &asn_DEF_CancelAllContracts, .format = asn1_format_label_only_as_json, .label = "adsc_cancel_all_contracts" },
	{ .type = &asn_DEF_CancelContract, .format = asn1_format_CHOICE_icao_as_json, .label = "adsc_cancel_contract" },
	{ .type = &asn_DEF_CancelPositiveAcknowledgement, .format = asn1_format_ENUM_as_json, .label = "adsc_cancel_ack" },
	{ .type = &asn_DEF_CancelRejectReason, .format = asn1_format_SEQUENCE_icao_as_json, .label = "cancel_reject_reason" },
	{ .type = &asn_DEF_ProviderAbortReason, .format = asn1_format_ENUM_as_json, .label = "provider_abort_reason" },
	...
	{ .type = &asn_DEF_UserAbortReason, .format = asn1_format_ENUM_as_json, .label = "adsc_user_abort" },
	// atn-b2_adsc_v2.asn1
	...
	{ .type = &asn_DEF_AirVectorModulus, .format = asn1_format_long_as_json, .label = "air_vector_modulus" },
	...
	{ .type = &asn_DEF_EPPNextWptInHorizonRequest, .format = asn1_format_label_only_as_json, .label = "report_next_wpt_in_horizon" },
	...
	{ .type = &asn_DEF_GroundVectorModulus, .format = asn1_format_long_as_json, .label = "ground_vector_modulus" },
	...
	{ .type = &asn_DEF_PlannedFinalAppSpeedModulus, .format = asn1_format_long_as_json, .label = "planned_final_approach_speed_modulus" },
	...
	{ .type = &asn_DEF_ProjectedProfileModulus, .format = asn1_format_long_as_json, .label = "projected_profile_modulus" },
	...
	{ .type = &asn_DEF_RNPProfileModulus, .format = asn1_format_long_as_json, .label = "rnp_profile_modulus" },
	...
	{ .type = &asn_DEF_RTAStatus, .format = asn1_format_ENUM_as_json, .label = "rta_status" },
	...
	{ .type = &asn_DEF_SpeedScheduleProfileModulus, .format = asn1_format_long_as_json, .label = "speed_schedule_profile_modulus" },
	...
	{ .type = &asn_DEF_WaypointName, .format = asn1_format_any_as_string_as_json, .label = "waypoint_name" },
	...
	{ .type = &asn_DEF_WindErrorModelUsed, .format = asn1_format_ENUM_as_json, .label = "wind_error_model_used" },
