...
asn_dec_rval_t
Associate_result_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Associate_result_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Associate_result_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Associate_result = {
	...
	Associate_result_decode_uper,
	Associate_result_encode_uper,
	...
	sizeof(asn_DEF_Associate_result_tags_1)
		/sizeof(asn_DEF_Associate_result_tags_1[0]), /* 1 */
	&asn_PER_type_Associate_result_constr_1,
